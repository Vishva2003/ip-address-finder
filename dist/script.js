...
const getIp = () => {
  const api =
    'https://geo.ipify.org/api/v2/country,city?apiKey=at_VjqyUaJYCrvNsPTewCRTZHsTAbLJN';
...
const getInputIp = () => {
  ...
  if (userInputValue === '') {
    ...
    if (userInputValue.match(ipformat)) {
      ...
      const api = `https://geo.ipify.org/api/v2/country,city?apiKey=at_VjqyUaJYCrvNsPTewCRTZHsTAbLJN&ipAddress=${userInputValue}`;
